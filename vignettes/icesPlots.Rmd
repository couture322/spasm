...
oaAll<-bind_rows(oaNull,oaMPA10,oaMPA15,oaAq,oaAqStay,oaAqStay2)%>%
...
oaPpue<-ggplot(oaAll[oaAll$year>49,],aes(year,ppue,color=run,group=run))+
  geom_line()+
  labs()+
  theme_bw()
