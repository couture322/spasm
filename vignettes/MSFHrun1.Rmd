...
* Juv. movement = 5
* Fish sp. = _P. virens_
* Fishing = "constant effort" (@ effort = 2000); reaction to MPA = "leave"
...
When size of the farm is held at 50% and different farm stay values are tested, there is little difference in PPUE.
