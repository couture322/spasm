...
The `spasm` package has a function `create_fish()` to create the appropriate fish population arguments to feed the simulations. 
...
ffFleet<-create_fleet(fish = ffFish,
                      cost_cv =  0,
                      cost_ac = 0,
                      cost_slope = 0,
                      q_cv = 0,
                      ...
                      sigma_effort = 0,
                      length_50_sel = 0.5 * ffFish$length_50_mature,
                      initial_effort = 1,
                      profit_lags =  1,
                      beta = 1,
                      max_cr_ratio = 0.2,
...
ffMngr<-create_manager(mpa_size = 0.75, 
                       year_mpa = 25)


ffSim<-sim_fishery(fish = ffFish,
            fleet = ffFleet,
            manager = ffMngr,
            #num_patches = 3,
            sim_years = 100,
...
plot_spasm(ffSim, type = "totals", font_size = 12)
